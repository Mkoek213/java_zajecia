...
public class CSVReader {
    ...
    public static void main(String[] args) throws IOException {
        CSVReader reader = new CSVReader("kolos/resources/super-toys.csv.csv", ",", true);

        while (reader.next()) {
            String product_code = reader.get("product_code");
            String name = reader.get("name");
            double price = reader.getDouble("price");
            int vat = reader.getInt("vat");
